...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("documentPath: \(documentPath) \n documentPath2: \(String(describing: documentPath2))")
        /*
        ...
        print("LibraryPath: \(LibraryPath) \n LibraryPath2: \(String(describing: libraryPath2))")
        /*
        ...
        print("read Array: \(String(describing: readArray))")
        ...
        print("customInfo目录下的所有文件: \(String(describing: fileArray))")
